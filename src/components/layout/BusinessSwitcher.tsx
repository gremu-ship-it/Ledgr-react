...
export function BusinessSwitcher() {
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        onClick={() => setOpen((v) => !v)}
        className="flex items-center gap-2 rounded-lg border border-line bg-card px-3 py-1.5 text-sm font-medium text-sub transition-colors hover:bg-brand-500/8 hover:text-ink"
      >
        <span
      ...
      {open && (
        <div className="absolute left-0 top-full z-40 mt-2 w-64 rounded-xl border border-line bg-card p-1.5 shadow-card dark:shadow-card-dark">
