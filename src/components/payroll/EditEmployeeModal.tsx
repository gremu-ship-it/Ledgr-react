      ...
      <div className="w-full max-w-lg rounded-2xl border border-line bg-card p-6 shadow-xl my-8">
        <div className="mb-5 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-semibold text-ink">Edit Employee</h2>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input type="number" min="0" step="0.01" value={form.gross_salary} onChange={(e) => set('gross_salary', e.target.value)}
                className={`w-full rounded-lg border px-3 py-2 text-sm focus:outline-none focus:ring-1 ${salaryChanged ? 'border-warning/30 focus:border-warning/40 focus:ring-amber-500' : 'border-line focus:border-brand-500 focus:ring-brand-500'}`} />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="mb-1 block text-sm font-medium text-sub">National ID</label>
              <input type="text" value={form.national_id} onChange={(e) => set('national_id', e.target.value)}
                className="w-full rounded-lg border border-line px-3 py-2 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500" />
            </div>
            <div>
              <label className="mb-1 block text-sm font-medium text-sub">TPIN</label>
          ...
          {salaryChanged && (
            <div className="flex items-center gap-2 rounded-lg bg-warning/12 px-3 py-2 text-xs text-warning">
